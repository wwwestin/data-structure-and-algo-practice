...
// You can cut the ith rectangle to form a square with a side length of k if both k <= li and k <= wi. For 
// example, if you have a rectangle [4,6], you can cut it to get a square with a side length of at most 4.
